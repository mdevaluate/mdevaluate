...
extensions = [
    Extension('mdevaluate.gromacs.coordinates', ['mdevaluate/gromacs/coordinates.pyx'], include_dirs=include_dirs),
    Extension('mdevaluate.gromacs.logarithmic', ['mdevaluate/gromacs/logarithmic.pyx'], include_dirs=include_dirs),
]
